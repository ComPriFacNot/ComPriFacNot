...
class PrimeFactoredIntegerTestSuite {
    ...
    static createTestCasesMap() {
        ...
        for (const [lcAliasDigit] of lcAliasDigitsMap) {
            ...
            PrimeFactoredIntegerTestSuite.addToMap(lcResult, lcTestName, lcAliasDigit, lcResultExpcected);
        }
        ...
        PrimeFactoredIntegerTestSuite.addToMap(lcResult, "Bad #7: 22", "22", null, "Parse error #7: Base \"2\" used 2 or more times");
